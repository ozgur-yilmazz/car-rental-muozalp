...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        try {
            ...
            // Initialize Extras
            Extra gps = createExtra("GPS", "GPS Navigation System", new BigDecimal("50.00"));
            Extra childSeat = createExtra("CHILD_SEAT", "Child Safety Seat", new BigDecimal("30.00"));
            Extra snowChains = createExtra("SNOW_CHAINS", "Snow Chains", new BigDecimal("40.00"));
            Extra additionalDriver = createExtra("ADD_DRIVER", "Additional Driver", new BigDecimal("100.00"));
            Extra wifi = createExtra("WIFI", "Mobile WiFi Hotspot", new BigDecimal("25.00"));
